    ...
    <div className="quiz-container" style={{ background: "#e7e6e6",marginTop:"60px", margin:"60px auto 0 auto"}}>
      {!quizStarted ? (
        <div>
          ...
          <p>
          Mrs Asia  is a 45-year-old woman who has been diagnosed with cirrhosis of the liver. 
          She has been experiencing symptoms such as fatigue, yellowing of the skin and eyes, 
          and fluid buildup in her abdomen. Mary's doctor has recommended that she undergo a 
          liver transplant, but she is hesitant to do so.
